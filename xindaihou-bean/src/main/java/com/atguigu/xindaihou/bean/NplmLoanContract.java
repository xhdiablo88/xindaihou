package com.atguigu.xindaihou.bean;
...
public class NplmLoanContract implements Serializable {
  ...
  @Column
  private long loanInstalments;//贷款分期数
  @Column
  ...
  @Transient
  private List<NplmLoanContract> nplmBorrowerInfoList;
  @Transient
  private  List<NplmLoanContract> nplmContractAttributeList;

  public List<NplmLoanContract> getNplmBorrowerInfoList() {
    return nplmBorrowerInfoList;
  }

  public void setNplmBorrowerInfoList(List<NplmLoanContract> nplmBorrowerInfoList) {
    this.nplmBorrowerInfoList = nplmBorrowerInfoList;
  }

  public List<NplmLoanContract> getNplmContractAttributeList() {
    return nplmContractAttributeList;
  }

  public void setNplmContractAttributeList(List<NplmLoanContract> nplmContractAttributeList) {
